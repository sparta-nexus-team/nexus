...
public interface WorkRepository extends JpaRepository<Work,Long> {
    ...
    @Query("select w from Work w WHERE w.employee.company.id = :company_id and w.work_date = :today")
    ...
    @Query("select w from Work w where w.employee.company.id = :company_id and w.work_date between :startDate and :endDate")
